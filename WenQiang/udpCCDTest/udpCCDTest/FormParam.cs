...
namespace udpCCDTest
{
    public partial class FormParam : Form
    {
        ...
        private void FormParam_Load(object sender, EventArgs e)
        {
            ...
            nCCD_Sa.Value = (decimal)SystemParam.CCD_Sa;
            nCCD_Sb.Value = (decimal)SystemParam.CCD_Sb;
        ...
        private void toolStripButton1_Click(object sender, EventArgs e)
        {
            ...
            SystemParam.CCD_Sa = (double)nCCD_Sa.Value;
            SystemParam.CCD_Sb = (double)nCCD_Sb.Value;
            ...
            SystemParam.NTmin2 = (uint)nNTmin.Value;
            SystemParam.n = (int)nn.Value;
            SystemParam.L = (int)nL.Value;
            SystemParam.L_BTM = (int)nL_BTM.Value;
            SystemParam.L_TOP = (int)nL_TOP.Value;
            SystemParam.NTexp2 = (uint)nNTexp.Value;
            SystemParam.NTdark = (uint)nNTdark.Value;
            SystemParam.delta_Tdark = (uint)ndelta_Tdark.Value;

            SystemParam.OeLight = (int)nOe.Value;
            SystemParam.lambda_Oe = (int)nlambda_Oe.Value;
            SystemParam.Np = (double)nNp.Value;
