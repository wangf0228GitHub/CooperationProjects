...
namespace CMOSTestLib.SaperaGUI
{
    public class LoadSaveDlg
    {
        ...
        public DialogResult ShowDialog()
        {
            ...
            // Update file object
            if (!UpdateBuffer()) return DialogResult.Abort;
       ...
       public String PathName
       {
        ...
        private SapBuffer m_pBuffer;
        private string m_PathName = "";
        private SapBuffer.FileFormat m_Type = SapBuffer.FileFormat.BMP;
        private string m_Options;
        private int m_StartFrame;
        private bool m_bSequence;
